...
public class OrderItemFlow {
    ...
    public OrderItem add(OrderItem orderItem) throws ApiException{
        ...
        inventoryApi.updateQuantityById(orderItem.getProductId(),0,orderItem.getQuantity());
    ...
    public OrderItem update(OrderItem orderItem) throws ApiException{
        ...
        inventoryApi.updateQuantityById(existingOrderItem.getProductId(), existingOrderItem.getQuantity(), orderItem.getQuantity());
